package com.bambrow.redis.controller;

import cn.hutool.core.lang.Dict;
import com.bambrow.redis.entity.Student;
import com.bambrow.redis.service.StudentService;
...
public class StudentController {
    ...
    public Dict selectByName(@PathVariable String name) {
        List<Student> ss = studentService.selectByName(name);
        return Dict.create().set("code", "200").set("data", ss);
    }

    @RequestMapping("/getUsername/{username}")
    public Dict selectByUsername(@PathVariable String username) {
        List<Student> ss = studentService.selectByUsername(username);
        return Dict.create().set("code", "200").set("data", ss);
    }
